...
void SZ_Memset  ( sizebuf_t *, int, int ); /* memset with a sizebuf */
void SZ_Memcpy  ( sizebuf_t *, const Uint8 *, int ); /* memcpy with a normal buffer */
void SZ_Memcpy2 ( sizebuf_t *, sizebuf_t *, int );   /* memcpy with a sizebuf */
